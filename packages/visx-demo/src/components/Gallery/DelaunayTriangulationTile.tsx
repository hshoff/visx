...
import type { DelaunayTriangulationProps } from '../../examples/visx-delaunay-triangulation/example';
import Delaunay from '../../examples/visx-delaunay-triangulation/example';
import GalleryTile from '../GalleryTile';

export { default as packageJson } from '../../examples/visx-delaunay-triangulation/package.json';
